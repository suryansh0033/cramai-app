...
function HomeContent() {
  ...
  <button
    onClick={downloadPDF}
    className="w-full py-3 rounded-xl font-bold text-sm border border-amber-400/40 text-amber-400 hover:bg-amber-400/10 transition-all duration-200 active:scale-95"
  >
    ⬇ Download as PDF
  </button>
</div>
