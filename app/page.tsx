...
{questions.length > 0 && (
  <div className="max-w-xl mx-auto mt-10">
    ...
    <button
  onClick={downloadPDF}
  className="w-full mt-6 py-3 rounded-xl font-bold text-sm border border-amber-400/40 text-amber-400 hover:bg-amber-400/10 transition-all duration-200 active:scale-95"
>
  ⬇ Download as PDF
</button>
