    ...
    <main className="min-h-screen bg-[#0f0f0f] text-white px-4 py-10 font-sans">
      ...
      {!loading && questions.length > 0 && mode === "important" && (
        <div className="max-w-xl mx-auto mt-10">
          ...
          <button
            onClick={downloadPDF}
            className="mt-6 w-full border border-amber-400/40 text-amber-400 hover:bg-amber-400/10 font-bold py-3 rounded-xl text-sm transition-all duration-200 active:scale-95"
          >
            ⬇ Download as PDF
          </button>
